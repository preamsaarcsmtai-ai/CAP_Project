...
ALTER TABLE "staff" ALTER COLUMN "designation" SET NOT NULL;--> statement-breakpoint
...
ALTER TABLE "staff" ADD COLUMN "collegeId" integer NOT NULL;--> statement-breakpoint
...
ALTER TABLE "staff" ADD CONSTRAINT "staff_collegeId_colleges_id_fk" FOREIGN KEY ("collegeId") REFERENCES "public"."colleges"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
